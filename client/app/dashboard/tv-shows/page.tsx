...
import ContinueCard from '@/app/components/ui/ContinueCard';
        ...
        <section className="relative h-[450px] rounded-3xl overflow-hidden group">
          ...
          <div className="relative h-full flex flex-col justify-center px-12 z-20 space-y-6 max-w-2xl">
            ...
            <p className="text-slate-300 text-lg leading-relaxed line-clamp-3">
              In a world reclaimed by nature, survival is just the beginning. Follow the journey of survivors as they navigate the
              remnants of civilization and face the ultimate choice.
            </p>
