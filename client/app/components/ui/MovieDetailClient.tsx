            ...
            <section className="relative h-[70vh] w-full shrink-0 animate-in fade-in duration-700">
              ...
              <div className="relative h-full flex flex-col justify-end px-12 pb-20 z-20 max-w-5xl">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <span className="text-slate-400 text-xs font-bold tracking-widest uppercase">2h 45m</span>
                  <span className="text-slate-400 text-xs font-bold tracking-widest uppercase">2024</span>
                </div>
                ...
                <p className="text-slate-300 text-lg md:text-xl leading-relaxed max-w-3xl font-medium mb-10">
                  ...
                  fabled Sun Pillar. As they navigate through treacherous shadows and face their inner demons, they discover that
                  the greatest darkness might be within themselves.
                </p>
            ...
            <section className="w-full bg-black animate-in zoom-in-95 fade-in duration-500 relative z-30">
              <div className="max-w-[1600px] mx-auto">
                <div className="aspect-video relative group">
                  <VideoPlayer title={movieTitle} videoUrl="/media/video.webm" autoPlay={true} />
                  {/* Close Player Button */}
                  <button
              ...
              <div className="lg:col-span-2 space-y-12">
                <section className="space-y-6">
                  ...
                  <p className="text-slate-400 text-lg leading-relaxed">
                    The year is 2142. Earth has been plunged into eternal night after the Great Collapse. The remaining survivors
                    live in massive, neon-lit citadels powered by the memories of the deceased. Elias, a memory scavenger, finds a
                    shard of pure sunlight hidden within the mind of a legendary explorer. This discovery sets off a chain of
                    events that could either restore the world or bring about its final destruction.
                  </p>
                </section>
